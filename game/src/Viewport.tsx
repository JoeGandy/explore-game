...
export interface ViewportProps {
  ...
  onViewPortClicked?: (event: any) => void;
}
...
const PixiViewportComponent = PixiComponent<PixiViewportComponentProps, Viewport>('Viewport', {
  create: ({ app, viewportPlugins, onViewPortClicked, ...viewportProps }) => {
    ...
    viewport.on('clicked', (event) => {
      console.log('Viewport was clicked', event);
      onViewPortClicked && onViewPortClicked(event);
    });
